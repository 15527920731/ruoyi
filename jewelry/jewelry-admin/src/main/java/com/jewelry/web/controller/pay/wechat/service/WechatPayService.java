package com.jewelry.web.controller.pay.wechat.service;
...
import com.jewelry.web.controller.pay.wechat.constant.GlobalConfig;
import com.jewelry.web.controller.pay.wechat.utils.MD5Util;
import com.jewelry.web.controller.pay.wechat.utils.XMLUtil;
...
public class WechatPayService {
	public static Log log = LogFactory.getLog(WechatPayService.class);
	...
	public Map<String, Object> forRefund(SortedMap<String, String> packageParams) throws KeyStoreException, IOException,
		...
		String xml = "<xml>" + 
				...
				+ "<out_refund_no><![CDATA[" + packageParams.get("out_refund_no")+ "]]></out_refund_no>" 
				+ "<total_fee><![CDATA[" + packageParams.get("total_fee") + "]]></total_fee>"
				+ "<refund_fee><![CDATA[" + packageParams.get("refund_fee") + "]]></refund_fee>"
				+ "<op_user_id><![CDATA[" + packageParams.get("mch_id") + "]]></op_user_id>" 
				+ "<sign>" + sign+ "</sign>" 
				+ "</xml>";
		...
		//FileInputStream inputStream = new FileInputStream("E:/IDEA workplace/shurencircle/src/apiclient_cert.p12");
		
		FileInputStream inputStream = new FileInputStream("D:/cert/apiclient_cert.p12");
